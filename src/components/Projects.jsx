...
const Projects = ({ projects }) => {
  ...
  return (
    <div className="flex flex-col bg-gray-900 px-6 mb-7">
...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div
      id="projects"
      className="rounded-lg bg-white shadow-lg bg-gre w-64 m-4"
    >
      <Link to={"/projects/" + project.id}>
        ...
        <div className="p-4">
          <h5 className="text-black">{truncate(project.title, 25, 0, 28)}</h5>
